---
name: speckit-help
description: List every spec-kit command grouped by phase of use, with one-line descriptions.
  Read this when you've forgotten which command to run next, or to onboard a new contributor
  (human or AI).
