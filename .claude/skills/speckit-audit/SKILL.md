---
name: speckit-audit
description: Audit the codebase against the TypeScript and Next.js behavioral directives
  in the constitution. Runs the audit script, summarizes findings by section and severity,
  and proposes prioritized fixes.
